...
1.
    ...
    - You usually run this first then the controller code immediately after in the docker container.
2.
    ...
    - To execute a task launch `ros2 launch dino_kg dino_recorder.launch` # TODO
